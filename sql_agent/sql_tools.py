...
@tool("list_tables", description="use this tool to list available tables")
...
SQL Query: """.format(query=query)
    ...
    model = init_chat_model(model="gemini-3.5-flash-lite", model_provider="google-genai", temperature=0)
